...
description: Panoramica della configurazione di  [!DNL Inventory Management]  a livello di catalogo e di prodotto per la visualizzazione, le scorte e il comportamento di spedizione in vetrina.
