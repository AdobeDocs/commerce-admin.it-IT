...
description: Configura le opzioni per prodotto [!DNL Inventory Management] e Inventario avanzato che sostituiscono le impostazioni globali relative alle scorte e all'origine.
