...
description: 'Assegna una o più origini a un prodotto nell''amministratore prima di impostare le quantità e le soglie per origine. [!DNL Inventory Management] '
