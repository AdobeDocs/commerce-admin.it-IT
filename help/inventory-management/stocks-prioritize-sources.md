...
description: Impostare l'ordine di priorità di origine su un magazzino dell'amministratore per controllare i consigli dell'algoritmo di selezione Source durante la spedizione.
