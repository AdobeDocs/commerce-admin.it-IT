...
description: Utilizza l'azione collettiva Assegna origini nell'amministratore per assegnare o annullare l'assegnazione di  [!DNL Inventory Management]  origini a più prodotti contemporaneamente.
