...
description: Configurare l'ordine di priorità di origine in un magazzino in modo che l'algoritmo Priorità Source consigli le origini per le spedizioni e le detrazioni.
