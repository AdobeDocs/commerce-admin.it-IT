...
Per offrire PayPal come metodo di pagamento nel tuo Negozio, devi disporre di un conto PayPal [business](https://manager.paypal.com/) e/o di un conto PayPal [Payflow](https://developer.paypal.com/docs/payflow/payflow-gateway/). I requisiti del conto sono specificati nella descrizione di ciascuna soluzione PayPal. Il tuo conto PayPal viene utilizzato anche per gestire i [filtri antifrode](#paypal-fraud-management-filters) applicati agli acquisti effettuati dal tuo store.
