...
* [[!DNL Commerce] crontab](https://experienceleague.adobe.com/it/docs/commerce-operations/configuration-guide/cli/configure-cron-jobs) è stato creato e i processi cron sono in esecuzione sul server installato.
