...
|----------------|-----------|-------|
| 2.4.7-p4 e versioni successive -p | 1.2.0. | Il supporto per 2.4.7-p4 richiede un [hotfix](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27147) |
