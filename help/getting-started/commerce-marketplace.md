...
- [Configurazione dell&#39;SDK dell&#39;interfaccia di amministrazione](https://developer.adobe.com/commerce/extensibility/admin-ui-sdk/)
...
È possibile creare più chiavi di accesso per scopi diversi e attivarle o disattivarle in base alle esigenze. È tuttavia necessario utilizzare la stessa chiave di accesso utilizzata per installare il software [!DNL Commerce]. Ad esempio, non puoi utilizzare una chiave di accesso al Magento Open Source per aggiornare Adobe Commerce, o viceversa. Non è inoltre possibile utilizzare una chiave di accesso appartenente a un altro utente o proveniente da un [account condiviso](commerce-account-share.md).
...
1. Al termine, fare clic su **[!UICONTROL OK]**.
   ...
   Osserva il collegamento _Copia_ dopo ogni chiave pubblica e privata. Nel passaggio successivo, copierai e incollerai questi valori per sincronizzare l’archivio con Commerce Marketplace.
...
Il team di supporto per il Marketplace risolve i problemi relativi solo ai siti [commerce.adobe.com/](https://commercemarketplace.adobe.com/) e [commerce.developer.adobe.com/](https://commercedeveloper.adobe.com/). Per informazioni sul Magento Open Source, rivolgiti al [Forum della community](https://community.magento.com/) o [contatta un partner](https://business.adobe.com/products/magento/partners.html) che possa fornire assistenza al Magento Open Source.
