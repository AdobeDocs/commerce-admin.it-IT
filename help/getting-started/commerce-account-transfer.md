...
1. Fare clic su **[!UICONTROL Continue]**.
   ...
   Viene creato un Adobe ID che viene collegato all’account Commerce corrente (MAGEID). Con questo collegamento di account, il campo _[!UICONTROL Email]_&#x200B;è bloccato da eventuali modifiche. L’indirizzo e-mail associato è gestito dall’account Adobe ID.
