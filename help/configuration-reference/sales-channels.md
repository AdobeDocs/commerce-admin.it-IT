...
Queste impostazioni sono disponibili quando [[!DNL Amazon Sales Channel]](https://experienceleague.adobe.com/it/docs/discontinued/using/commerce-channels) è installato.
