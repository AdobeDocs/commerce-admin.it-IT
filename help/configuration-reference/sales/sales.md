...
![Impostazioni multicoupon](./assets/sales-multicoupon-settings.png)<!-- zoom -->
...
![Limitazione di frequenza](assets/sales-rate-limiting.png)<!-- zoom -->
