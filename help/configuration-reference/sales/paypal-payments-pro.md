...
description: Rivedi le impostazioni di configurazione nella sezione [!UICONTROL PayPal Payments Pro] della pagina [!UICONTROL Sales] &gt; [!UICONTROL Payment Methods] dell'amministratore di Commerce.
