...
description: Rivedi le impostazioni di configurazione nella sezione [!UICONTROL PayPal Payments Advanced] della pagina [!UICONTROL Sales] &gt; [!UICONTROL Payment Methods] dell'amministratore di Commerce.
...
| [!UICONTROL Sort Order] | Visualizzazione store | Numero che determina l&#39;ordine di visualizzazione del Checkout PayPal Express quando viene elencato con altri metodi di pagamento durante il pagamento. Immetti `0` come primo elemento dell&#39;elenco. |
