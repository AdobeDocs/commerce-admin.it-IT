...
>[!NOTE]
>
>La navigazione a livelli standard descritta in questa sezione è diversa dalla navigazione filtrata di Live Search con [facet](https://experienceleague.adobe.com/docs/commerce/live-search/live-search-admin/facets/facets.html).
...
>[!NOTE]
>
>La configurazione della navigazione del prezzo descritta in questo argomento è diversa per [Live Search](https://experienceleague.adobe.com/docs/commerce/live-search/overview.html).
...
>[!NOTE]
>
>La configurazione standard descritta in questa pagina è diversa per [Live Search](https://experienceleague.adobe.com/docs/commerce/live-search/overview.html).
