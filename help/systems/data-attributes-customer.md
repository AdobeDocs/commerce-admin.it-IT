...
| `dob` | La data di nascita del cliente. <br><br>**_Importante:_** In linea con le attuali best practice per la sicurezza e la privacy, controlla l&#39;archiviazione e l&#39;elaborazione della data di nascita completa dei clienti (mese, giorno, anno). Se raccolto con altri identificatori personali (ad esempio _nome completo_), potrebbe rappresentare un rischio legale e di sicurezza. Consigliamo di limitare la memorizzazione delle date di nascita complete dei clienti e di utilizzare invece l’anno di nascita del cliente come alternativa. |
