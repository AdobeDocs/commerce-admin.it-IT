...
Se nella configurazione sono abilitati [preventivi B2B](configure-quotes.md), la negoziazione dei prezzi può essere avviata da un acquirente autorizzato da una società o da un rappresentante commerciale.

Gli acquirenti avviano il processo di negoziazione del prezzo [richiedendo un preventivo](quote-request.md) dal carrello. I rappresentanti commerciali possono avviare la negoziazione [creando un preventivo provvisorio per un acquirente](sales-rep-initiates-quote.md), aggiornando il preventivo con gli articoli dell&#39;ordine e i prezzi iniziali e inviandolo all&#39;acquirente.
...
1. Nella barra laterale di amministrazione, vai a **[!UICONTROL Sales]** > **[!UICONTROL Quotes]**.

   La nuova richiesta viene visualizzata nella griglia _[!UICONTROL Quotes]_.
...
1. In _[!UICONTROL Quote & Account Information]_, fai clic sull&#39;icona_ Calendario _(![Icona Calendario](../assets/icon-calendar.png)).
...
- Per applicare le modifiche e aggiornare il preventivo al catalogo condiviso e alle regole di prezzo, fare clic su **[!UICONTROL Update Prices]** e quindi su **[!UICONTROL Proceed]** per confermare l&#39;aggiornamento.
...
1. Nella casella _Aggiungi commento_ fare clic su **[!UICONTROL Attach file]**.
   ...
   Per impostazione predefinita, [i file allegati](../configuration-reference/sales/quotes.md) possono avere una dimensione massima di 2 MB in uno dei seguenti formati: DOC, DOCX, XLS, XLSX, PDF, TXT, JPG o JPEG, PNG.
...
1. Invia o salva il preventivo:
   ...
   - Per continuare a utilizzare il preventivo in un secondo momento, fare clic su **[!UICONTROL Save as Draft]**.

>[!NOTE]
>
> Durante la negoziazione del preventivo, gli sconti possono essere bloccati per impedire ulteriori modifiche. Una volta bloccato un preventivo, non è possibile modificare né il tipo di sconto né l&#39;importo senza sbloccarlo. Questo meccanismo di bloccaggio garantisce il mantenimento delle condizioni concordate tra il rappresentante commerciale e l&#39;acquirente.
...
| [!UICONTROL Catalog Total Price  (Incl./Excl. Tax)] | Il prezzo totale degli articoli del preventivo senza imposte, in base ai prezzi nel catalogo condiviso o nel catalogo principale utilizzato come base del preventivo. Espandere la sezione per visualizzare i valori utilizzati nel calcolo, a seconda dell&#39;impostazione [Visualizza subtotale](../configuration-reference/sales/tax.md) nella configurazione. Opzioni: <br/>**[!UICONTROL Subtotal (Excl. Tax)]**- Il prezzo totale del catalogo senza imposta stimata.<br/>**[!UICONTROL Subtotal (Incl. Tax)]** - Il prezzo totale del catalogo senza imposta stimata. <br/>**[!UICONTROL Estimated Tax]**- L&#39;importo dell&#39;imposta che si stima verrà applicata al prezzo totale del catalogo. |
| Prezzo negoziato | Lo sconto offerto all&#39;acquirente può essere basato su uno dei seguenti elementi: <br/>**[!UICONTROL Percentage Discount]**- Lo sconto in percentuale.<br/>**[!UICONTROL Amount Discount]** - Sconto come importo fisso. <br/>**[!UICONTROL Proposed Price]**- Prezzo proposto dal venditore.<p>Se tutti gli articoli del preventivo hanno uno sconto articolo bloccato, la sezione [!UICONTROL Negotiated Price] è disabilitata perché non è possibile applicare ulteriori sconti.</p><p>Se un prodotto ha uno sconto articolo linea non bloccato, sia lo sconto articolo linea che lo sconto a livello di preventivo vengono applicati al prezzo del prodotto.</p> |
