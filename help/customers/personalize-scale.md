...
1. [[!DNL Audience Activation]](https://experienceleague.adobe.com/en/docs/commerce-admin/customers/audience-activation): utilizza tipi di pubblico [!DNL Real-Time CDP] per personalizzare blocchi di contenuto dinamici, promozioni e regole di prodotto correlate nel tuo sito Adobe [!DNL Commerce].
