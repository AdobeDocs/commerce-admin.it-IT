...
1. [Connessione dati](https://experienceleague.adobe.com/en/docs/commerce/data-connection/overview): consente di condividere i dati di vetrina, back office e profilo cliente da Adobe [!DNL Commerce] alla rete Edge di Adobe Experience Platform per l&#39;utilizzo in applicazioni Adobe Experience Cloud, tra cui:
