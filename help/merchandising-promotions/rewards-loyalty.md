...
| [!UICONTROL Reason] | Motivi per l&#39;assegnazione dei punti:<br>**[!UICONTROL Making purchases]**— Ogni volta che il cliente effettua un acquisto, può guadagnare punti.<br>**[!UICONTROL Registering on the site]** - Accumulato al momento della registrazione (una volta).<br>**[!UICONTROL Subscribing to a newsletter]**- Accantonamento per la prima sottoscrizione (una volta).<br>**[!UICONTROL Sending Invitations]** — Guadagna punti invitando i propri amici a partecipare al sito.<br>**[!UICONTROL Converting Invitations to Customer]**— Guadagna punti per ogni invito inviato, amici principali che si registrano sul sito.<br>**[!UICONTROL Converting Invitations to Order]** — Guadagna punti per ogni vendita in seguito a un invito inviato.<br>**[!UICONTROL Review Submission]**— Guadagna punti per l&#39;invio di recensioni di prodotti. |
