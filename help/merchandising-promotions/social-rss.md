...
Il tuo archivio può essere connesso ai social network installando una [estensione Marketplace](../getting-started/commerce-marketplace.md). Inoltre, puoi aggiungere facilmente plug-in per social network come il pulsante _Mi piace_ ai blocchi di CMS che possono essere incorporati nelle pagine di tutto lo store.

I siti di social networking dispongono di numerosi plug-in che possono essere facilmente aggiunti al tuo store. Inoltre, in Commerce Marketplace sono presenti molte estensioni che possono essere utilizzate per integrare il negozio con i social media. Nell&#39;esempio seguente viene illustrato come aggiungere un pulsante _Mi piace_ di Facebook allo store.

>[!NOTE]
>
>Adobe Commerce ha rimosso l&#39;integrazione nativa di Facebook _Magento Social_ e non supporta più l&#39;estensione. Vai a [Commerce Marketplace](https://marketplace.magento.com/catalogsearch/result/?q=Facebook){:target="_blank"} per individuare estensioni alternative per l&#39;integrazione Facebook.

### Passaggio 1: Ottieni il codice del pulsante

1. Nel sito Web per sviluppatori di Meta, vai alla pagina [installazione pulsante](https://developers.facebook.com/docs/plugins/like-button).
...
1. Aggiungi lo snippet di codice al contenuto del blocco, a seconda dello strumento di contenuto:
   ...
   - Quando utilizzi [!DNL Page Builder], aggiungi un blocco [Codice HTML](../page-builder/html-code.md) nell&#39;area di visualizzazione e incolla lo snippet di codice copiato dal sito di Facebook. In caso contrario, incollare il frammento di codice nella casella **[!UICONTROL Content]**.

   - Con l&#39;editor, incollare il frammento di codice copiato dal sito di Facebook nella casella **[!UICONTROL Content]**.
