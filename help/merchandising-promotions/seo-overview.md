...
Per informazioni sulla scelta tra reindirizzamenti dei termini di ricerca, riscritture URL, regole [!DNL Live Search] e indirizzamento storefront, vedere [Reindirizzamenti dei termini di ricerca e indirizzamento storefront](search-term-redirects.md).
