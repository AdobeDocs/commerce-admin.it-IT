...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Aggiunta la precisazione che <a href="https://experienceleague.adobe.com/en/docs/commerce-admin/systems/security/encryption-key">ruotando una chiave di crittografia</a> verranno immediatamente invalidate tutte le sessioni cliente e amministratore.</p>
</td>
      <td>
        Tecnico
      </td>
