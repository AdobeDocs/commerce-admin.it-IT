...
description: Scopri il tipo di contenuto Testo, utilizzato per aggiungere un contenitore di testo nel [!DNL Page Builder] fase.
...
Utilizza il _Testo_ tipo di contenuto per aggiungere un contenitore di testo con un editor WYSIWYG (&quot;What You See Is What You Get&quot;) nel [[!DNL Page Builder] fase](workspace.md#stage). Inoltre, è possibile aggiungere collegamenti, immagini, [Variabili](../systems/variables-predefined.md)e widget per il testo dalla barra degli strumenti dell’editor.
...
Puoi accedere all’editor di testo direttamente dall’area di visualizzazione o da una pagina di impostazioni. Le modifiche apportate direttamente all&#39;area di visualizzazione vengono salvate automaticamente. Per ulteriori informazioni, consulta [Utilizzo dell’editor](../content-design/editor.md).
...
![Casella degli strumenti Contenitore testo](./assets/pb-elements-text-toolbox.png){width="600"}
...
| Nascondi | ![Nascondi icona](./assets/pb-icon-hide.png){width="25"} | Nasconde il contenitore di testo. |
| Spettacolo | ![Mostra icona](./assets/pb-icon-show.png){width="25"} | Mostra il contenitore di testo nascosto. |
| Duplica | ![Icona Duplica](./assets/pb-icon-duplicate.png){width="25"} | Crea una copia del contenitore di testo. |
...
1. In [!DNL Page Builder] pannello, espandere **[!UICONTROL Elements]** e trascina un **[!UICONTROL Text]** segnaposto per una riga, colonna o gruppo di schede sullo stage.

   ![Trascinamento di un segnaposto di testo sullo stage](./assets/pb-elements-text-drag.png){width="600" zoomable="yes"}
...
Per creare un collegamento per un numero di telefono o un messaggio e-mail, consulta [Aggiunta di variabili personalizzate](../systems/variables-custom.md).
...
1. Seleziona il testo nell’editor e fai clic su _Inserisci/modifica collegamento_ ( ![Pulsante Inserisci/modifica collegamento](./assets/pb-icon-add-link.png){width="20"} ) sulla barra degli strumenti dell&#39;editor.
...
1. Per **[!UICONTROL Title]**, immetti `Shop Tees`.
   ...
   Il `Title` l&#39;attributo link viene utilizzato da alcuni browser come descrizione comando.
...
1. Clic _Inserisci/modifica immagine_ ( ![Pulsante Inserisci/modifica immagine](./assets/icon-pb-add-image.png){width="20"} ) sulla barra degli strumenti dell&#39;editor.

1. Per **[!UICONTROL Source]**, fare clic sull&#39;icona di ricerca per utilizzare l&#39;archiviazione multimediale per individuare e selezionare un&#39;immagine.

1. Per **[!UICONTROL Image Description]**, immettere il testo descrittivo per l&#39;immagine.

   Questo testo compila il `alt` attributo di collegamento per l&#39;immagine e viene utilizzato da alcuni browser per l&#39;accessibilità.
...
1. Per inserire l&#39;immagine e quindi tornare al [!DNL Page Builder] Workspace, fai clic su **[!UICONTROL OK]**.

## Modificare le impostazioni del testo

1. Passa il puntatore del mouse sul contenitore di testo per visualizzare la casella degli strumenti e scegli _Impostazioni_ ( ![Icona Impostazioni](./assets/pb-icon-settings.png){width="20"} ).
...
1. Aggiornare il _[!UICONTROL Advanced]_in base alle esigenze.
   ...
   - Per controllare il posizionamento del testo all&#39;interno del contenitore principale, scegliete un **[!UICONTROL Alignment]**:
   ...
   - Imposta il **[!UICONTROL Border]** stile applicato ai quattro lati del contenitore di testo:
   ...
   - Immetti i valori, in pixel, per il **[!UICONTROL Margins and Padding]** per determinare i margini esterni e la spaziatura interna del contenitore di testo.
